...
wait_network() {
    ...
    # Up to ~90s, then launch anyway (a cloud-less demo beats no demo).
    i=0
    while [ "$i" -lt 30 ]; do
    ...
    log "network NOT ready after 90s -> launching cloud-less (restart service once network is up)"
}
